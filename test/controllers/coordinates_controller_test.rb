...
class CoordinatesControllerTest < ActionController::TestCase
  ...
  test "should create coordinate" do
    assert_difference('Coordinate.count') do
      post :create, coordinate: { coordinates: @coordinate.coordinates, pages_id: @coordinate.pages_id, product_name: @coordinate.product_name }
    end
  ...
  test "should update coordinate" do
    patch :update, id: @coordinate, coordinate: { coordinates: @coordinate.coordinates, pages_id: @coordinate.pages_id, product_name: @coordinate.product_name }
    assert_redirected_to coordinate_path(assigns(:coordinate))
  end
