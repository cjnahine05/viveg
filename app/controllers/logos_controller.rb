class LogosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @logo.save
        format.html { redirect_to logos_url, notice: 'Logo was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @logo.update(logo_params)
        format.html { redirect_to logos_url, notice: 'Logo was successfully updated.' }
  ...
  private
    ...
    def logo_params
      params.require(:logo).permit(:name, :image , :status)
    end
end
