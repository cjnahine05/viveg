class MerchantsController < ApplicationController
  ...
  def merchant_banners
    @merchant_banners = Banner.all.where(:merchant_id => params[:merchant_id])
    @banners_merchants = Merchant.all.find(params[:merchant_id])
  ...
  private
    ...
    def merchant_params
      params.require(:merchant).permit(:company_name, :representative, :contact_number, :address, :email, :password)
    end
end
